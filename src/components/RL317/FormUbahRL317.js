...
if(jumlah_item_obat >= jumlah_item_obat_rs ){
    ...
    try {
            ...
            await axiosJWT.patch('/apisirs6v2/rltigatitiktujuhbelas/' + id, data, customConfig)
    ...
    const getRLTigaTitikTujuhBelasById = async (id) => {
        setSpinner(true)
        const response = await axiosJWT.get('/apisirs6v2/rltigatitiktujuhbelas/'+ id, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
    ...
    <form onSubmit={Simpan}>
        ...
        <div className="row mt-3">
            <div className="col-md-12">
                <Link to={`/rl317/`} className='btn btn-info' style={{fontSize:"18px", backgroundColor: "#779D9E", color: "#FFFFFF"}}>
