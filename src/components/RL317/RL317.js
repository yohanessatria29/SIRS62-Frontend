...
export const RL317 = () => {
    ...
    const getRL = async (e) => {
        ...
        try {
            ...
            //     });
            // });
            const total_obat = rlTigaTitikTujuhBelasDetails.reduce((previousValue, currentValue) => {
                return previousValue + currentValue.jumlah_item_obat;
            }, 0);

            const total_obat_rs = rlTigaTitikTujuhBelasDetails.reduce((previousValue, currentValue) => {
    ...
    const deleteRL = async (id) => {
        ...
        try {
            await axiosJWT.delete(`/apisirs6v2/rltigatitiktujuhbelas/${id}`,
                customConfig)
        ...
        <div className="row">
            <div className="col-md-12">
                <div style={{marginBottom: "10px"}}>
                    {
                        user.jenisUserId === 4 ? (
                                <Link className='btn' to={`/rl317/tambah/`} style={{ marginRight: "5px", fontSize: "18px", backgroundColor: "#779D9E", color: "#FFFFFF" }}>
                                    +
                                </Link>
