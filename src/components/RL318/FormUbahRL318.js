...
export const FormUbahRL318 = () => {
    ...
    const Simpan = async (e) => {
        ...
        try {
            ...
            await axiosJWT.patch('/apisirs6v2/rltigatitikdelapanbelas/' + id, data, customConfig)
    ...
    const getRLTigaTitikDelapanBelasById = async (id) => {
        setSpinner(true)
        const response = await axiosJWT.get('/apisirs6v2/rltigatitikdelapanbelas/'+ id, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
    ...
    <form onSubmit={Simpan}>
        ...
        <div className="row mt-3">
            <div className="col-md-12">
                <Link to={`/rl318/`} className='btn btn-info' style={{fontSize:"18px", backgroundColor: "#779D9E", color: "#FFFFFF"}}>
